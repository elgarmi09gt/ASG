...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'ANALYSES'],
        [
            'text'        => 'Analyse Par Clients',
            'url'         => '/clients',
            'icon'        => 'far fa-fw fa-user-circle'
        ],
        [
            'text'        => 'Analyse Par Fournisseurs',
            'url'         => '/fournisseurs',
            'icon'        => 'far fa-fw fa-id-card'
        ],
        [
            'text'        => 'Analyse Par Maçon',
            'url'         => '/macons',
            'icon'        => 'far fa-fw fa-user'
        ],
        // [
        //     'text'        => 'Analyse Par Facture',
        //     'url'         => '/factures',
        ...
        //     ],
        // ],
        ['header' => 'DOCUMENTS UTILES'],
        [
            'text'       => 'Factures Fictives',
            'url'         => '/factures',
        ...
        // ['header' => 'DOCUMENTS RECEMMENT RECU'],
        // [
        //     'text'       => 'Arrêts',
        //     'url'         => '/arrets',
        //     'icon'        => 'fa fa-hourglass-half',
