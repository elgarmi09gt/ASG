  ...
  <div class="container-fluid">
    <div class="card card-default">
      <div class="card-header text-center">
        <h3 class="text-center" style="background: #2196f3; color: #fff; padding: 20px;">LES ARRÊTS LIES</h3>
      </div>
      <div class="card-body">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            @else
            <tr>
              <th colspan="4" class="text-center">Aucun Arret Enregistr&eacute; !</th>
            </tr>
            @endif
          </tbody>
        </table>
...
<script>
  // Show function Fournisseur
    $(document).on('click', '.show-modal', function() {
        ...
        var fichier = '{{ asset('files/arrets/')}} ' + '/' + $(this).data('fichier') + '.pdf';
